...
"""
v022 update
now that my system is larger, it seems to take longer when retrieving data from the bridge...
that's annoying... 
...
0908 2118 update
    -added hue and sat mutlti threading
        - fucking hooray! 
...
when exiting from saturation, need a returning screen. 
when switching from ct to hue, or from hue to sat, check transition screen. 
"""
import os
