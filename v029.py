...
FUCKED UP. 
added some debug
changed the scenes around. 5am wakeup only for now though 
...
def ct_control(device,mode):
    ...
    refresh = 1
    prev_mills = 0 
    debugmsg("after variable declaration")
    while exitvar == False:
        if(pos > max_rot_val):
            pos = max_rot_val
        elif(pos < 0):
        ...
        if(not GPIO.input(21)):
            debugmsg("exiting because button pushed")
            exitvar = True
        time.sleep(0.01)
...
while True:
    ...
    if(not GPIO.input(21)):
        if(display == 0):
            ...
            debug = os.popen("curl -H \"Accept: application/json\" -X PUT --data '{\"on\":true,\"bri\":1,\"transitiontime\":100}' " + api_url + "/groups/7/action").read()
            debug = os.popen("curl -H \"Accept: application/json\" -X PUT --data '{\"on\":false,\"transitiontime\":100}' " + api_url + "/groups/4/action").read()
            hue_groups(lnum = "6",lon = "true",lbri = "253",lsat = "200",lx = "-1",ly = "-1",ltt = "100",lct = "443")
            #print(debug)
        elif(display == 6):
            display_2lines("Turning lights:","5am wakeup",12)
            #hue_lights(lnum = "1",lon = "true",lbri = "250",lsat = "256",lx = "-1",ly = "-1",ltt = "100", lct = "-1")
            ##hue_lights(lnum = "2",lon = "false",lbri = "144",lsat = "256",lx = "-1",ly = "-1",ltt = "100", lct = "-1")
            #hue_lights(lnum = "5",lon = "true",lbri = "250",lsat = "117",lx = "0.4423",ly = "0.4059",ltt = "100", lct = "-1")
            #time.sleep(1)
            #hue_lights(lnum = "6",lon = "true",lbri = "250",lsat = "256",lx = "-1",ly = "-1",ltt = "100", lct = "-1")
            #hue_lights(lnum = "7",lon = "true",lbri = "1",lsat = "1",lx = "-1",ly = "-1",ltt = "100", lct = "381")
            #hue_lights(lnum = "8",lon = "true",lbri = "254",lsat = "1",lx = "-1",ly = "-1",ltt = "100", lct = "443")
            #hue_lights(lnum = "9",lon = "true",lbri = "250",lsat = "117",lx = "0.4423",ly = "0.4059",ltt = "100", lct = "-1")
            #hue_lights(lnum = "10",lon = "true",lbri = "250",lsat = "117",lx = "0.4423",ly = "0.4059",ltt = "100", lct = "-1")
            #time.sleep(1)
            #hue_lights(lnum = "11",lon = "true",lbri = "250",lsat = "117",lx = "0.4423",ly = "0.4059",ltt = "100", lct = "-1")
            #hue_lights(lnum = "12",lon = "true",lbri = "250",lsat = "-1",lx = "-1",ly = "-1",ltt = "100", lct = "-1")
            #hue_lights(lnum = "13",lon = "true",lbri = "254",lsat = "150",lx = "-1",ly = "-1",ltt = "100", lct = "375")
            #hue_lights(lnum = "14",lon = "true",lbri = "250",lsat = "256",lx = "-1",ly = "-1",ltt = "100", lct = "-1")
            #hue_lights(lnum = "15",lon = "true",lbri = "250",lsat = "1",lx = "-1",ly = "-1",ltt = "100", lct = "419")
            #------------------------------- after fuckup-----------------------------------
            #Special Bedroom
            #hue_groups(lnum = "1",lon = "true",lbri = "254",lsat = "1",lx = "-1",ly = "-1",ltt = "100",lct = "352")
            #Brian light on
            hue_lights(lnum = "12",lon = "true",lbri = "254",lsat = "1",lx = "-1",ly = "-1",ltt = "100", lct = "352")
            #Mika light off
            hue_lights(lnum = "10",lon = "false",lbri = "254",lsat = "1",lx = "-1",ly = "-1",ltt = "100", lct = "419")
            time.sleep(1)
            hue_groups(lnum = "2",lon = "true",lbri = "254",lsat = "137",lx = "-1",ly = "-1",ltt = "100",lct = "359")
            hue_groups(lnum = "3",lon = "true",lbri = "254",lsat = "-1",lx = "-1",ly = "-1",ltt = "100",lct = "-1")
            time.sleep(1)
            hue_groups(lnum = "4",lon = "true",lbri = "254",lsat = "-1",lx = "-1",ly = "-1",ltt = "100",lct = "-1")
            #Dont touch guest
            #hue_groups(lnum = "5",lon = "false",lbri = "254",lsat = "-1",lx = "-1",ly = "-1",ltt = "100",lct = "-1")
            hue_groups(lnum = "6",lon = "true",lbri = "254",lsat = "121",lx = "0.4448",ly = "0.4066",ltt = "100",lct = "-1")
            time.sleep(1)
            hue_groups(lnum = "7",lon = "true",lbri = "254",lsat = "1",lx = "-1",ly = "-1",ltt = "100",lct = "404")
        elif(display == 7):
