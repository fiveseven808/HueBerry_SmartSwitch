...
"""
v007 update
wrote get light names and get group names function
took forever, but they work well. just gotta import the data back into the menus and read the arrays in :) 
...
def get_light_names():
    ...
    return name_array,num_lights,total
