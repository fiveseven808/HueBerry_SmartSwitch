...
v010 update
goals:
try to get CT adjustment at least
Maybe hue adjustment as well? 
extend light control functions and group light and groups? giant pita in though... g for group l for light
"""
import time
