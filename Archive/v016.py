...
"""
v016 update
big ass bugs about the display not returning properly becuase of the new display system

gotta go and check brightness levels and returning back to higher level functions

----------
looks like i squashed the bugs
added a little transition screen when returning from editing light values

still gotta add color temp and hue modes... maybe long press on a light will activate it?  like .5 or .75 second?
