#!/usr/bin/env python
"""
v020 untested update
wanna do it quick and dirty... 
just implememnt CT selection for lights instead of just groups.... 
maybe edit the groups one and pass l and g like the other thing 

well i implemented it... ct is now one function for groups or lights

also added a bit more to the hue info screen... wanted max light id for my own purposes

v020 holy shit it works!
most of it works. merging with normal code
just a tiny timing issue with the info screen

v020 later....
added hue function and sat function
works when holding down the button... i.e.

select light
click 
    -> brightness
hold for .5 seconds
    -> ct mode if avaliable
hold for .5 seconds
    -> hue mode if avaliable
hold for .5 seconds
    -> sat mode if avaliable
