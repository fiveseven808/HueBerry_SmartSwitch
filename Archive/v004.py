...
deleted unecessary sleeps
added a .5 sec aleep cycle during the time display. Slow to get into (adjustment) mode, however 
process goes from 40-50% down to 12%. 
.25 sec rises to 22% and doesn't improve lag all that much... Of course removing it or putting at .1 results in a very responsive system... 

need to work on interrupts to handle the other menus... 
