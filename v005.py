...
"""
v004-5 update
don't know what, if anything i did in v4
v5 though... i added an extension for the menu... i.e. sub menus... a function per sub menu.. messy but it works LOL 
also added a clock and a line so that you can see what time it is when you navigate the menus... gonna put a battery and wifi indicator in there as welll i guess
...
def alt_menu_test():
    ...
    while exitvar == False: 
        ...
        if(display == 1):
            display_2lines("1. Group","Control",17)
        elif(display == 2):
            display_2lines("2. Light","Control",17)
        elif(display == 3):
        ...
        if(not GPIO.input(16)):
            if(display == 1):
                display_custom("display 1 pushed")
                time.sleep(1)
            elif(display == 2):
                display_custom("display 2 pushed")
                time.sleep(1)
            elif(display == 3):
                time.sleep(0.25)
                exitvar = True
...
while True:
    ...
    if(display == 0):
        ...
        display_2lines("8. 2nd Level", "Menu",18)
